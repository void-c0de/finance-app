...
• Konten & Umsätze – manuell oder per Demo-/Sandbox-Bankanbindung (nur Lesen)
• Automatische Kategorisierung mit eigenen Regeln
• Monatsbudgets, Sparziele, wiederkehrende Zahlungen
• Analysen & Cashflow-Prognose (Premium, nach Sicherheit gekennzeichnet)
• Lokale SQLCipher-Verschlüsselung, App-Sperre per Biometrie
• Backup/Restore als Datei, CSV-Export – nichts wird automatisch hochgeladen
• Optionale Cloud-Synchronisierung, Konto- & Datenlöschung in App und Browser

Bitte meldet Abstürze, Verwirrung in den ersten Minuten und alles, was sich
falsch anfühlt – mit Gerät und Android-Version.
```
